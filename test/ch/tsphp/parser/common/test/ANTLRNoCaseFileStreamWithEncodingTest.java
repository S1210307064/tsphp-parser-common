...
public class ANTLRNoCaseFileStreamWithEncodingTest extends  ARNoCaseStreamTest
{
    @Rule
    ...
    protected CharStream createStream(String input) throws IOException {
        ...
        writer.write(input);
        writer.close();
        return new ANTLRNoCaseFileStream(file.getPath(), StandardCharsets.UTF_8.name());
    }
}
